        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-24">
          ...
          <div className="bg-[#0F0F0F] border border-white/5 p-8 md:p-12 relative group overflow-hidden">
            ...
            <p className="text-sm md:text-base text-gray-400 font-kamerick leading-relaxed">
              Jordan Patel sets the strategic direction, drawing on his experience founding Art Quarter in Digbeth. His work brings together brand development, food and personal service environments, creative skills programmes and community activity. He has led the development of relationships across local government, education, business and the voluntary sector, alongside work on the creator economy and cultural infrastructure. Through Artdot, Jordan brings that practical experience to strategy and partnership development, while a team of specialists executes the work.
            </p>
          </div>
          ...
          <div className="bg-[#0F0F0F] border border-white/5 p-8 md:p-12 relative group overflow-hidden">
            ...
            <p className="text-sm md:text-base text-gray-400 font-kamerick leading-relaxed">
              Every project has a named lead and an agreed team. We bring together strategic, creative and delivery specialists according to the brief, with clear responsibilities and a shared understanding of what needs to be achieved. We deliver the strategy.
            </p>
          </div>
